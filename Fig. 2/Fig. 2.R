...
DF_melt$Combined_type=factor(DF_melt$Combined_type, levels=c("No-take MPA expansion 2010-2022", "No-take MPA extent 2022", "All MPA expansion 2010-2022",
                                                             "All MPA extent 2022"))
...
#Change the 0s that are >0 manually
#Peru 
...
#Change Peru because it has one MPA 
DF_melt_2_NT[10, 8] = "<0.1%"

#Add the Banco Volcan Expansion in Panama 
...
#grid
ggsave(here::here("Fig. 2","Grid of results three scatterplots_1412_2023.jpeg"), grid, width=180*3, height = 160, units = "mm")
